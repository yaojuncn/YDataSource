...
public class YConnection implements Connection{
	...
	/**
	 * last used time in [the current time in milliseconds]
	 */
	...
	public void realClose(){
		...
		try {
			...
			// if not auto commit
			if(!this.internalConnection.getAutoCommit()){
	...
	public Statement createStatement() throws SQLException {
		...
		try {
			...
			YStatement ystat = new YStatement(stat, this, ds.getQuerytimeout());
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		...
		try {
			...
			YPreparedStatement ystat = new YPreparedStatement(stat, this, ds.getQuerytimeout());
	...
	public CallableStatement prepareCall(String sql) throws SQLException {
		...
		try {
			...
			YCallableStatement ystat = new YCallableStatement(stat, this, ds.getQuerytimeout());
